...
<script src="/Map/Vendor/Highcharts/js/modules/exporting.js"></script>
<script src="/Map/getMapPoints.js.php<?php echo (isset($_GET['mode']) && $_GET['mode'] === '2d') ? '?mode=2d&' : '?'; ?>maxdistance=<?php echo (int)($settings['maxdistance'] ?? 50); ?>"></script>
<script>
